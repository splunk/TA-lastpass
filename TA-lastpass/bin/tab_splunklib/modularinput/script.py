...
from tab_splunklib.client import Service
from tab_splunklib.modularinput.event_writer import EventWriter
from tab_splunklib.modularinput.input_definition import InputDefinition
from tab_splunklib.modularinput.validation_definition import ValidationDefinition
...
class Script(object):
    ...
    def service(self):
        ...
        :return: :class:tab_splunklib.client.Service. A value of None is returned,
