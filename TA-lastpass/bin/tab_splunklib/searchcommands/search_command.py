...
class SearchCommand(object):
    ...
    def search_results_info(self):
        ...
        with open(info_path, 'rb') as f:
            ...
            import csv
            reader = csv.reader(f, dialect='tab_splunklib.searchcommands')
    ...
    def service(self):
        ...
        :return: :class:`tab_splunklib.client.Service`, if :code:`enableheader` and
            :code:`requires_srinfo` are both :code:`true`. Otherwise, if either
            :code:`enableheader` or :code:`requires_srinfo` are :code:`false`,
            a value of :code:`None` is returned.
        ...
        try:
            if len(args) >= 2 and args[1] == '__GETINFO__':
                ...
                message = (
                    ...
                    u'configuration is unsupported by tab_splunklib.searchcommands. '
