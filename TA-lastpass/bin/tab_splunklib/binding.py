...
"""The **tab_splunklib.binding** module provides a low-level binding interface to the
...
:mod:`tab_splunklib.client` module.
"""
...
class _NoAuthenticationToken(object):
    """The value stored in a :class:`Context` or :class:`tab_splunklib.client.Service`
...
def _authentication(request_fun):
    ...
    **Example**::
        ...
        import tab_splunklib.binding as binding
...
def namespace(sharing=None, owner=None, app=None, **kwargs):
    ...
    :type app: ``string``
    :returns: A :class:`tab_splunklib.data.Record` containing the reconciled
        namespace.
...
class AuthenticationError(HTTPError):
    ...
    in a call to :meth:`Context.login` or :meth:`tab_splunklib.client.Service.login`,
