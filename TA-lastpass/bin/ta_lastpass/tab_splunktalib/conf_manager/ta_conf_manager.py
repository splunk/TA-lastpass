...
import tab_splunktalib.credentials as cred
import tab_splunktalib.conf_manager.conf_manager as conf
import tab_splunktalib.conf_manager.request as conf_req
...
class TAConfManager(object):
    ...
    def __init__(self, conf_file, splunkd_uri, session_key, appname=None):
        ...
        self._conf_mgr = conf.ConfManager(splunkd_uri,
                                          session_key,
                                          app_name=appname)
    ...
    def create(self, stanza):
        ...
        self._conf_mgr.create_stanza(self._conf_file, encrypted_stanza["name"],
                                     encrypted_stanza)
