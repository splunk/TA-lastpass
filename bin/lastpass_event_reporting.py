...
'''
    ...
    Add your modular input logic to file input_module_lastpass_event_reporting.py
'''
class ModInputlastpass_event_reporting(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputlastpass_event_reporting, self).__init__("ta_lastpass", "lastpass_event_reporting", use_single_instance)
...
if __name__ == "__main__":
    exitcode = ModInputlastpass_event_reporting().run(sys.argv)
    sys.exit(exitcode)
